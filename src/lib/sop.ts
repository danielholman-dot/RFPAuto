...
RFP Submission Deliverables
 Deliverables - Submittal 1 - MARCUS RFP GC Q&A 
...
Instructions: In the sheet, notate the RFP section you are inquiring about and list your question(s). 
 Deliverables - Submittal 2 - MARCUS Commercial SPGC Proposal Template
...
Additionally, provide a detailed justification for your proposed fee structure, demonstrating how it incentivizes cost-effectiveness, efficiency, and high-quality performance while ensuring fair compensation for your services.
 Deliverables - Submittal 3 - Declaration Involvement in Litigation and/or Arbitration
...
Amount in dispute
 Deliverables - Submittal 4 - CGA [MARCUS] Construction Template for U.S. Projects  
...
Review the non-localized CGA [MARCUS] Construction Template for U.S. Projects file within the drive folder and make edits directly in the document while in ‘suggesting mode’. When making edits, work directly within the file located in the drive folder and refrain from altering the file name. 
 Please follow the steps below to review the contract and suggest markups, if any.
Open document titled: “CGA [MARCUS] Construction Template for U.S. Projects”
On the right side of your screen, click Editing and select Suggesting from the drop down menu to enable all changes to be tracked:

Begin making markups within the document.
 Deliverables - Submittal 5 - Pilot Project Team Resumes
...
Notification of Changes: If awarded the Google RFP scope of work, the Supplier must seek Google program owner approval for any personnel changes to the proposed project key roles.  Notice must be provided to the Google program owner along with a resume of the replacement individual.  Any individual must be approved by the Google program owner commencing work on a Google site.
 Deliverables - Submittal 6 - Presentation 
Purpose: The presentation serves two primary purposes:
Introduction: Introduce your proposed project team, showcasing their expertise, experience, and qualifications relevant to the MARCUS program and specific to the operating.
...
The tentative agenda for the presentation is as follows:
Kickoff by Google Team 
GC Presentation 
Team General Q&A 
Wrap up 
Logistics:
The proposal presentation and some Q&A sessions will be held virtually. Each participant is requested to individually log into the video conference so their names are visible and the meeting video should be enabled.
Q&A Sessions: The Google facilitator will use a predetermined set of questions that will be asked of the individuals specific to the role. Google may seek future clarification to any responses.
It is recommended that the proposed project / delivery team attend the presentation (including members of the proposed partner, if applicable) to discuss their experience and credentials with Google.
2.7 Deliverables - Submittal 7 - Recording Consent - MARCUS SPGC RFP 2025
...
Instructions:
Please complete and submit the attached consent form along with your emailed acknowledgment of receipt of this RFP. Additionally, forward this document in a separate email to release-form-repository@google.com.
General RFP Terms & Conditions
 Overview
This document sets out the Terms and Conditions under which this Request For Proposal (RFP) has been issued. Parties responding to this RFP (referred to as “Participant”) should comply with all the requirements set out below.
 Confidentiality
This Request For Proposal process is confidential and information contained in the RFP documentation is proprietary to Google. The information shall be used by the Participant only for the purpose of preparing a response and shall not be disclosed to third parties without prior written consent.
With regard to the above, you commit to Google that you shall keep in strict confidence all information disclosed by Google within this RFP and not, directly or indirectly:
Disclose any or all such information to any person, firm, corporation, association or any other entity for any reason or purpose whatsoever; or
Communicate with or contact any vendor, equipment supplier and/or sub-contractor or provide them access to the information which concerns or relates to this RFP; or
Use, either wholly or partially, any such information disclosed by Google other than for the purposes of complying with the requirements of this RFP.
All terms and conditions of the NDA executed with your firm shall apply to this RFP.
Your company must get written approval from Google before disclosing confidential information to any third parties. Your company must also sign an NDA with any third parties with whom you plan to communicate confidential information.
 No Obligation
...
Google reserves the right to use information submitted in response to this RFP in any manner it may deem appropriate in evaluating the suitability of the proposed solution. Materials submitted by participants that are considered confidential must be clearly marked as such. Google reserves the right to use any and all ideas presented in any response unless the Participant identifies such ideas as proprietary in the response.
 Pricing Validity and Completeness
The pricing and terms submitted by the Participant should be valid for a minimum of one hundred and eighty days from the date of submission. All relevant charges and all critical assumptions made in response to the RFP should be fully documented in the submission.  Any applicable taxes should be clearly stated.
 Process Integrity
Refer to The “RFP Communication” section for the designated person(s) for all inquiries and responses pertaining to this RFP process. Existing suppliers may continue to interact with other Google contacts if discussions are related to the conduct of existing or regular course of business. Any attempt to circumvent this RFP process may result in disqualification. 
...
Google is committed to treating all workers with respect and dignity, ensuring safe working conditions, and conducting environmentally responsible, ethical operations. Google expects suppliers in our operations and supply chain, and their suppliers, to embrace the social, environmental, and ethical responsibilities. Therefore, all suppliers to Google must comply with the Google Supplier Code of Conduct.
...
If you have not done so already, please click on this link to sign up for a Google Docs account using your corporate email address as only then will you be able to access all the documents.
 Qualification Requirements for New Partners 
All directly contracted Google suppliers are contractually required to follow the qualification process under our construction agreements and be registered and qualified in Google’s Supplier Information Management System, Achilles. If you need more information, please see the Achilles Guidance and Subcontractor Playbook. If unable to view these documents, please reach out to vps_support@googlegroups.com to get access to the guide
`;
