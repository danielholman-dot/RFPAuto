...
export default function NewContractorPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      const newContractorData = {
        ...
        performance: Math.floor(Math.random() * 21) + 80, // Random performance between 80-100
      };
      
      await addDoc(contractorsCol, newContractorData);

      toast({
        title: "Contractor Created",
        description: `Contractor "${values.name}" has been successfully added.`,
      });
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle>Create a New Contractor</CardTitle>
          <CardDescription>
            Fill out the details below to add a new contractor to the system.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
